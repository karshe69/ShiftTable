                ...
                <div className="flex-row pl-4 justify-end h-fit m-auto">
                    <ul className="grid w-full gap-8 md:grid-rows-2">
                        <li onClick={(e) => setShow("perm")}>
                            ...
                            <label htmlFor="perm-reservs" className="text-2xl font-semibold inline-flex items-center justify-between w-min p-2 rounded-lg cursor-pointer peer-checked:text-secondary hover:bg-bg_prim">permanent reservations</label>
                        </li>
                        <li onClick={(e) => setShow("temp")}>
                            <input type="radio" id="temp-reservs" name="reservs" value="temp-reservs" className="hidden peer"></input>
                            <label htmlFor="temp-reservs" className="text-2xl font-semibold inline-flex items-center justify-between w-min p-2 rounded-lg cursor-pointer peer-checked:text-secondary hover:bg-bg_prim">temporary reservations</label>
                        </li>
                    </ul>
                </div>
            </div>
